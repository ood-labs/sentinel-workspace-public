...
static const PNode kRecords[13] = {
    ...
    { float3(-1.600000, 1.320000, 3.380000), 1.000000, 17.000000, 1436880768.000000, 3.141590, 1.420000, 1.080000, 0.120000, float2(0.000000, -1.000000) },
    { float3(1.100000, 1.320000, 3.380000), 1.000000, 17.000000, 3568190720.000000, 3.141590, 1.420000, 1.080000, 0.120000, float2(0.000000, -1.000000) },
...
void main(uint3 id : SV_DispatchThreadID)
{
    ...
    if (i == 0) {
        ...
        r.position = float3(room_offset.x + art_center_x + side * art_spread * 0.5,
                            art_height,
                            room_offset.y + room_depth * 0.5 - 0.20);
        r.yaw = 3.14159;
        r.dir = float2(0.0, -1.0);
    } else if (i == 12) {
