...
Reference: `RefImages/Industrial/lambdafab-steelstruct.jpg` — looking up into a dense concrete/steel
structural cage: square box-section columns at grid points, horizontal beams in X and Z at every floor.
...
Proof: `captures/lattice_lookup.png` (look-up hero), `captures/lattice_orbit_first.png`.
