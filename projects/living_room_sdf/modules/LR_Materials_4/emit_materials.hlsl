...
void main(uint3 id : SV_DispatchThreadID)
{
    ...
    if (i == 0)  m = makeMaterial(oak_color, .52, oak_color * float3(.38,.48,.60), 0, 3.2, .38, 1, 0, .34, .10, 11);
    if (i == 1)  m = makeMaterial(plaster_color, .94, plaster_color * 1.06, 0, 1.7, .32, 2, 0, .08, .12, 23);
    ...
    if (i == 5)  m = makeMaterial(walnut_color, .48, walnut_color * float3(.34,.46,.60), 0, 4.5, .36, 1, 0, .36, .10, 59);
    if (i == 6)  m = makeMaterial(rug_color, .96, rug_color * .62, 0, 10.0, .28, 5, 0, .04, .05, 61);
    if (i == 7)  m = makeMaterial(sofa_color, .92, sofa_color * 1.16, 0, 24, .30, 6, 0, .04, .06, 71);
    if (i == 8)  m = makeMaterial(chair_color, .64, chair_color * float3(.52,.60,.68), 0, 16, .28, 7, 0, .24, .05, 73);
    if (i == 9)  m = makeMaterial(walnut_color * .76, .42, walnut_color * .36, 0, 6.5, .34, 1, 0, .38, .08, 79);
    ...
    if (i == 15) m = makeMaterial(leaf_color, .78, leaf_color * float3(.25,.48,.28), 0, 12, .78, 9, 0, .10, .42, 107);
