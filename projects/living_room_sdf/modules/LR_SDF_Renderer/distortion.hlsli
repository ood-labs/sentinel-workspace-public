// Strata-style world-space domain distortion shared by every living-room SDF layer.
// fx_amount is a true master kill; layerMix lets architecture, seating, and media
// peel apart while still evaluating the same deformation field.
