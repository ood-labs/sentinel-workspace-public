...
void main(uint3 id : SV_DispatchThreadID)
{
    ...
    if (i == 0)  m = makeMaterial(oak_color, .52, oak_color * float3(.38,.48,.60), 0, 3.2, .90, 1, 0, .34, .34, 11);
    ...
    if (i == 5)  m = makeMaterial(walnut_color, .48, walnut_color * float3(.34,.46,.60), 0, 4.5, .88, 1, 0, .36, .28, 59);
    if (i == 6)  m = makeMaterial(rug_color, .96, rug_color * .48, 0, 10.0, .72, 5, 0, .04, .46, 61);
    if (i == 7)  m = makeMaterial(sofa_color, .92, sofa_color * 1.24, 0, 24, .86, 6, 0, .04, .58, 71);
    if (i == 8)  m = makeMaterial(chair_color, .64, chair_color * float3(.38,.50,.62), 0, 16, .76, 7, 0, .24, .38, 73);
    if (i == 9)  m = makeMaterial(walnut_color * .76, .42, walnut_color * .24, 0, 6.5, .86, 1, 0, .38, .24, 79);
