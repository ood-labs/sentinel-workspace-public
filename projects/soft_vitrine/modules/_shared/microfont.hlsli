// microfont.hlsli — 5x7 bitmap glyph set for the matik_plate show.
// The reference plate is covered in small alphanumeric tags (Z4626, 785, FREQ, MATIK, E1),
// and every editor readout must show real live state, so both the console and the
// instrument renderer need honest text. One shared table, no per-module duplicates.
//
// Glyph index space: 0-9 = digits, 10-35 = A-Z, 36 '-', 37 '.', 38 '/', 39 ':', 40 '+', 41 '>'
#ifndef MX_MICROFONT_HLSLI
#define MX_MICROFONT_HLSLI
