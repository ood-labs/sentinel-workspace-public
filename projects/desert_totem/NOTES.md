...
Full write-up: `docs/devlogs/desert_totem_debrief.md`. Technique entries in
`knowledge/technique-catalogue.md` (see **Domain-distortion warp toolkit ⭐**).
...
back off Melt. See the debrief for the crash analysis.
