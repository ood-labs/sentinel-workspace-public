...
- Merged public commit `e308c8c` and loaded the TouchDesigner starter with no unresolved paths.
...
- Add the approved starter to the final public lineup and begin the full seed documentation,
  knowledge, skills, and validation refresh.
