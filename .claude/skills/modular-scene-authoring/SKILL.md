...
The single most important decision is the data contract, and it comes from the structure of the reference image, not from a favorite technique. Do not force every reference into a texture atlas or into hand-authored curves.
